      ...
      <div class="lendi__pillars-wrap">
        ...
        <div class="lendi__pillars">
          <article v-for="pillar in pillars" :key="pillar.number" class="lendi__pillar">
            ...
            <ul class="lendi__pillar-list">
              <li v-for="item in pillar.bullets" :key="item">{{ item }}</li>
            </ul>
          </article>
        </div>
      </div>
